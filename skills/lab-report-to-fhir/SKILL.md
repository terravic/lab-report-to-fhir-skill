...
2. **Map Clinical Ontologies**:
   - Consult the [LOINC and SNOMED Mapping Reference](references/loinc_snomed_mapping.md) to assign standard LOINC codes (e.g. `94076-7` for MCED cfDNA methylation, `77983-5` for SEPT9 methylation, `2857-1` for Total PSA, `69548-6` for BRCA1/2 NGS).
...
3. **Construct Valid FHIR R4 Bundle**:
   - Review [FHIR R4 Schema Reference](references/fhir_r4_schemas.md).
...
- [LOINC and SNOMED CT Ontology Mapping](references/loinc_snomed_mapping.md)
- [HL7 FHIR R4 Resource Schemas](references/fhir_r4_schemas.md)
- [EHR Integration Guide (Epic, Cerner, Cloud FHIR Stores)](references/ehr_integration_guide.md)
